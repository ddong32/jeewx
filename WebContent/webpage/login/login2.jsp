...
<body>
	...
	<div id="versionBar">
		<div class="copyright"> <%--&copy; 版权所有 
			<span class="tip"> 
				<a href="http://www.jeewx.com" title="Jeewx 捷微管家平台" target="_blank">JeeWx 捷微管家平台</a>
				(推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度) &nbsp;&nbsp;&nbsp;技术支持: 
				<a href="http://www.jeecg.org" title="Jeecg 开源社区" target="_blank">Jeecg开源社区</a> 
			</span>--%>
		</div>
	</div>
	<!-- Link JScript-->
