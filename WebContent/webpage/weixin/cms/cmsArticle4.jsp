...
<body class="easyui-layout" fit="true">
    ...
    <div data-options="region:'center',split:true" id="layout">
        <!-- 头部图片 -->
        ...
        <!-- 基本信息  -->
        <div class="media_edit_area data-edit-layout" id="edit_cmsArticle" style="display:none">
        ...
        <!-- 行程列表  -->
        <div id="data-list-cmsRouteList" class="data-edit-layout" style="display:none">
        ...
        <!-- 注意事项 -->
        <div id="data-notice" class="data-edit-layout" style="display:none">
        ...
        <!-- 费用包含 -->
        <div id="data-expense-contain" class="data-edit-layout" style="display:none">
        ...
        <!-- 费用不包含 -->
        <div id="data-expense-ncontain" class="data-edit-layout" style="display:none">
