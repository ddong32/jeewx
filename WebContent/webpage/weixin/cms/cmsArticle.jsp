 ...
 <body class="easyui-layout" fit="true">
    <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cmsArticleController.do?save" beforeSubmit="beforeSubmit_formobj">
        ...
        <div data-options="region:'west',split:true" style="width:575px;">
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'north'" title="头部图片" style="height:300px">
                    <t:datagrid name="cmsPhotoList" actionUrl="cmsPhotoController.do?datagrid&articleId=${cmsArticlePage.id}"
                     idField="id" fit="true" sortName="createdate" sortOrder="asc" queryMode="group" pagination="false"
                     onLoadSuccess="onLoad_cmsPhotoList">
        ...
        <div data-options="region:'east',split:true" title="预览" style="width:400px;overflow:hidden;">
            ...
            <iframe name="cmsArticlePreviewer" width="100%" height="100%" frameborder="0" src="./cruiseController.do?detail"
            onload="preview()"></iframe>
        </div>
        </t:formvalid>
    ...
    <div id="routeWindow" class="easyui-window"
     data-options="title:'编辑行程',closed:true,collapsible:false,minimizable:false,maximizable:false,modal:true"
    ...
    <div id="viewPhotoWindow" class="easyui-window"
     data-options="title:'预览图片',closed:true,collapsible:false,minimizable:false,maximizable:true,modal:true"
