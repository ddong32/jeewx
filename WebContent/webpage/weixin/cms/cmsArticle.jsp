...
<body class="easyui-layout" fit="true">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cmsArticleController.do?save" beforeSubmit="beforeSubmit_formobj">
    ...
    <div data-options="region:'west',split:true" style="width:575px;">
      <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north'" title="头部图片" style="height:300px">
          <t:datagrid name="cmsPhotoList" actionUrl="cmsPhotoController.do?datagrid&articleId=${cmsArticlePage.id}" idField="id" fit="true" sortName="createdate" sortOrder="asc" queryMode="group" pagination="false" onLoadSuccess="onLoad_cmsPhotoList">
            ...
            <t:dgFunOpt title="删除" funname="delPhoto" />

            <t:dgToolBar title="上传" icon="icon-add" onclick="uploadPhoto()" width="100%" height="100%"></t:dgToolBar>
            ...
            <t:dgToolBar title="查看" icon="icon-search" onclick="viewPhoto()" width="100%" height="100%"></t:dgToolBar>
          </t:datagrid>
        </div>
      </div>
      <div data-options="region:'center',title:'基本信息',iconCls:'icon-ok'">
            ...
            <div class="inner">
              <div id="js_appmsg_editor">
                <div style="margin-top: 0px;">
                  <div>
                    <input id="id" name="id" type="hidden" value="${cmsArticlePage.id }"> <input type="hidden" name="accountid" value="${cmsArticlePage.accountid}"> <input type="hidden" name="imageName" id="imageName" value="${cmsArticlePage.imageName}"> <input type="hidden" name="photosId"> <input type="hidden" name="routesId">
                    <table cellpadding="0" cellspacing="0" class="formtable" style="background-color:transparent;">
                      ...
                      <tr>
                        ...
                        <td class="value"><t:dictSelect field="columnId" dictTable="weixin_cms_menu where accountid='${sessionScope.WEIXIN_ACCOUNT.id}'" dictField="id" dictText="name" defaultVal="${cmsArticlePage.columnId}"></t:dictSelect> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">所属栏目</label></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="value">
                          <%-- <textarea class="inputxt" id="summary" name="summary" style="width: 300px" datatype="*">${cmsArticlePage.summary}</textarea>
                                                            ...
                                                            <label class="Validform_label" style="display: none;">行程天数</label> --%> <input class="inputxt" id="days" name="days" style="width: 40px" value="${cmsArticlePage.days}">天 <input class="inputxt" id="nights" name="nights" style="width: 40px" value="${cmsArticlePage.nights}">晚
                        </td>
                      </tr>
                    </table>
                  </div>
    ...
    <div data-options="region:'center',iconCls:'icon-ok'">
      <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',title:'行程列表'" style="height:300px">
          <t:datagrid name="cmsRouteList" actionUrl="cmsRouteController.do?datagrid&articleId=${cmsArticlePage.id}" idField="id" fit="true" sortName="createDate" sortOrder="asc" queryMode="group" pagination="false" onLoadSuccess="onLoad_cmsRouteList">
            <t:dgCol title="编号" field="id" hidden="false"></t:dgCol>
            ...
            <t:dgCol title="行程" field="traffic" hidden="false"></t:dgCol>
            <t:dgCol title="行程" field="traffic_trim" width="160"></t:dgCol>
            <t:dgCol title="录入时间" field="createDate" width="120" formatter="yyyy-MM-dd hh:mm:ss"></t:dgCol>
            <t:dgCol title="操作" field="opt" width="80"></t:dgCol>

            <%-- <t:dgFunOpt title="编辑" funname="editRoute" /> --%>
            <t:dgFunOpt title="删除" funname="delRoute" />

            <t:dgToolBar title="录入" icon="icon-add" onclick="addRoute()" width="100%" height="100%"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="icon-edit" onclick="editRoute()" width="100%" height="100%"></t:dgToolBar>
    ...
    <div data-options="region:'east',split:true" title="预览" style="width:400px;overflow:hidden;">
      ...
      <iframe name="cmsArticlePreviewer" width="100%" height="100%" frameborder="0" src="./cruiseController.do?detail" onload="preview()"></iframe>
    </div>
  </t:formvalid>
  ...
  <div id="routeWindow" class="easyui-window" data-options="title:'编辑行程',closed:true,collapsible:false,minimizable:false,maximizable:false,modal:true" style="width:740px;height:498px">
    <div class="appmsg_content">
      <form name="routeForm" action="./cmsRouteController.do?save" method="post">
        <input type="hidden" name="articleId" value="${cmsArticlePage.id}" /> <input type="hidden" name="id" /> <input type="hidden" name="routePhotosId" />
        <table cellpadding="0" cellspacing="0" class="formtable" style="background-color:transparent;">
          <tr>
          ...
          <tr>
            ...
            <td class="value trafficbox">早餐 <t:dictSelect field="breakfast" dictTable="t_s_type where typegroupid in (select id from t_s_typegroup where typegroupcode='ycap')" dictField="typecode" dictText="typename" defaultVal="0"></t:dictSelect> , 午餐 <t:dictSelect field="lunch" dictTable="t_s_type where typegroupid in (select id from t_s_typegroup where typegroupcode='ycap')" dictField="typecode" dictText="typename" defaultVal="0"></t:dictSelect> , 晚餐 <t:dictSelect field="dinner" dictTable="t_s_type where typegroupid in (select id from t_s_typegroup where typegroupcode='ycap')" dictField="typecode" dictText="typename" defaultVal="0"></t:dictSelect>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right" style="width:10em"><label class="Validform_label"> 图片<span class="uploadButtonWrapper"><input type="button" value="上传" />: <input id="cmsRoutePhotoupload" type="file" name="cmsRoutePhotoFile" class="uploadButton"></span>
            </label></td>
            <td class="value">
              <div>
