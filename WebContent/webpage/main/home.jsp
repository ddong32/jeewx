...
<div class="funcList" id="func">
    <ul class="list">
        ...
        <li>
            ...
            <h3>微投票</h3>
            <p>用户通过微信问答<font color="red">[商业提供]</font></p>
        </li>
        <li>
            <img src="./plug-in/weixin/img/func14.jpg">
            <h3>微信墙 </h3>
            <p>活跃现场气氛，让粉丝涨起来<font color="red">[商业提供]</font></p>
        </li>
        <li>
            <img src="./plug-in/weixin/img/func15.jpg">
            <h3>微社区</h3>
            <p>移动社区交流<font color="red">[商业提供]</font></p>
        </li>
         <li>
            <img src="./plug-in/weixin/img/func02.jpg" width="105" height="107">
            <h3>会员卡</h3>
            <p>方便携带 永不挂失<br>消费积分<font color="red">[商业提供]</font></p>
        </li>
      
        <li>
            <img src="./plug-in/weixin/img/func03.jpg" width="107" height="107">
            <h3>微商城</h3>
            <p>小微信也有大商城<br>电商轻松就能走入微信<font color="red">[商业版提供]</font></p>
        </li>
        <li>
            <img src="./plug-in/weixin/img/func09.jpg">
            <h3>支付组件</h3>
            <p>支付宝、财付通、微信支付等多种支付方式<font color="red">[商业版提供]</font></p>
        </li>
	    -->
    </ul>
</div>
