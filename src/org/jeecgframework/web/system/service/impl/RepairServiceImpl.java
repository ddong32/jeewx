...
public class RepairServiceImpl extends CommonServiceImpl implements RepairService {
    ...
    private void repairCgFormField() {
        ...
        //
        // CgFormFieldEntity jform_cgreport_head_cgr_sql = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_head_content = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_field_name = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_order_num = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_s_mode = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_replace_va = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_dict_code = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_s_flag = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_cgrhead_id = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_field_txt = new
        // CgFormFieldEntity();
        ...
        //
        // CgFormFieldEntity jform_cgreport_item_field_type = new
        // CgFormFieldEntity();
    ...
    private void repairCkEditor() {
        ...
        String str = "<html><head><title></title><link href='plug-in/easyui/themes/default/easyui.css' id='easyuiTheme' rel='stylesheet' type='text/css' />"
                ...
                + "&nbsp;&nbsp;单位：人填&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                + "&nbsp;&nbsp;&nbsp; 报日期：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 年&nbsp;&nbsp; 月&nbsp;&nbsp; 日</p><"
                + "form action='cgFormBuildController.do?saveOrUpdate' id='formobj' method='post' name='formobj'>" + "<input name='tableName' type='hidden' value='${tableName?if_exists?html}' /> "
                ...
                + "<td colspan='6' rowspan='2'><p>&nbsp;</p><p>人数</p></td><td colspan='5' rowspan='2'>" + "<p>&nbsp;</p><p>学历</p></td><td colspan='4' rowspan='2'><p>&nbsp;</p><p>取得的（上岗）执业资格</p>"
                ...
                + "<input name='b3' size='4' type='text' value='${b3?if_exists?html}' /></p></td><td><p>" + "<input name='b4' size='4' type='text' value='${b4?if_exists?html}' /></p></td><td><p>"
                + "<input name='b5' size='4' type='text' value='${b5?if_exists?html}' /></p></td><td><p>" + "<input name='c1' size='4' type='text' value='${c1?if_exists?html}' /></p></td><td><p>"
                + "<input name='c2' size='4' type='text' value='${c2?if_exists?html}' /></p></td><td><p>" + "<input name='c3' size='4' type='text' value='${c3?if_exists?html}' /></p></td><td><p>"
                + "<input name='c4' size='4' type='text' value='${c4?if_exists?html}' /></p></td><td><p>" + "<input name='c5' size='4' type='text' value='${c5?if_exists?html}' /></p></td><td><p>"
                + "<input name='d1' size='4' type='text' value='${d1?if_exists?html}' /></p></td><td><p>" + "<input name='d2' size='4' type='text' value='${d2?if_exists?html}' /></p></td><td><p>"
                + "<input name='d3' size='4' type='text' value='${d3?if_exists?html}' /></p></td><td><p>" + "<input name='d4' size='4' type='text' value='${d4?if_exists?html}' /></p></td><td><p>"
                + "<input name='e1' size='4' type='text' value='${e1?if_exists?html}' /></p></td><td><p>" + "<input name='e2' size='4' type='text' value='${e2?if_exists?html}' /></p></td><td><p>"
                + "<input name='e3' size='4' type='text' value='${e3?if_exists?html}' /></p></td><td><p>" + "<input name='e4' size='4' type='text' value='${e4?if_exists?html}' /></p></td></tr>"
                + "<tr><td colspan='20'><p>&nbsp;</p><p>填报说明：</p><p>一、合计（A）：填报至统计截止期的本机构的人员总数。</p>" + "<p>二、人数：</p><p>在编人员：分别按照价格认证机构编制内及其它具有价格主管部门编制的实有人数填报在B1、B2栏内。"
                + "</p><p>聘用人员：按照经价格主管部门或价格认证机构人事部门认可的并签订三年以上的工作合同的人员（B3）；以及没有经过价" + "格主管部门或价格认证机构人事部门认可的签订合同少于三年的人员（B4）分别来进行统计。</p><p>临时（借用）人员（B5）：特指"
                + "外聘的临时工，或者工作关系不在本单位且无长期聘用合同的借调人员等。</p><p>三、表内各栏目关系</p><p>A=B1+B2+B3+B4+B5=C1+" + "C2+C3+C4+C5=D1+D2+D3+D4=E1+E2+E3+E4</p></td></tr></tbody></table></form></div></body></html>";
    ...
    private void repairMenu() {
        TSIcon defaultIcon = commonDao.findByProperty(TSIcon.class, "iconName", "默认图").get(0);
