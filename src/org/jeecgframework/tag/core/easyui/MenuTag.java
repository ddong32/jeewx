...
public class MenuTag extends JeecgTag {
    ...
    public int doEndTag() throws JspTagException {
        ...
        try {
            ...
            out.flush();
            // String menu = (String)
            // this.pageContext.getSession().getAttribute("leftMenuCache"+style);
            // if(menu!=null){
            // out.print(menu);
            // out.flush();
            // }else{
    ...
    public String toString() {
        ...
        builder.append(",sysTheme=").append(SysThemesUtil.getSysTheme(ContextHolderUtils.getRequest()).getStyle()).append(",brower_type=")
                .append(ContextHolderUtils.getSession().getAttribute("brower_type")).append("]");
